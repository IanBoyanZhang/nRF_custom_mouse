PROJECT_NAME := ble_app_hids_mouse_s132_pca10036
...
GNU_INSTALL_ROOT := $(HOME)/Workspace/nrf/tools/gcc-arm-none-eabi-6-2017-q2-update
GNU_VERSION := 6.3.1
...
$(abspath ../../../../../../components/ble/ble_services/ble_hids/ble_hids.c) \
...
INC_PATHS  = -I$(abspath ../../../config/ble_app_hids_mouse_s132_pca10036)
...
INC_PATHS += -I$(abspath ../../../../../../components/ble/ble_services/ble_hids)
...
nrf52832_xxaa_s132: LINKER_SCRIPT=ble_app_hids_mouse_gcc_nrf52.ld

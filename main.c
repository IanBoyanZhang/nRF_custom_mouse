...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    // OUR_JOB: Step3.C, Housekeeping of ble connections related to our service and characteristic
...
/**@brief Function for the GPIO configuration.
 */
